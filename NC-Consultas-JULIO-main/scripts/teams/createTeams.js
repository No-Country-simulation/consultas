...
async function createTeams() {
  try {
    ...
    members.forEach((member) => {
      const encontrado = member.cohortHistory.find((c) => c.cohort == 21);
      // console.log(encontrado);
      if (encontrado.assigned == false) {
        // Agrego los REACT
        if (
        ...
        // Agrego NODE!!!!!!!!!!!
          ...
          (encontrado.language == "Typescript" ||
            encontrado.language == "Javascript") &&
          encontrado.availability == "Mañana"
        ) {
    ...
    javaManana.forEach((JAVA) => {
      ...
      teams.push(`${numero};${JAVA.email};JAVA;m;java`);
      i++;
    });
    ...
    javaFulllTime.forEach((JAVA) => {
      ...
      teams.push(`${numero};${JAVA.email};JAVA;ft;java`);
      i++;
    });
    ...
    javaNoche.forEach((JAVA) => {
      ...
      teams.push(`${numero};${JAVA.email};JAVA;n;java`);
      i++;
    });
    ...
    typeManana.forEach((tipo) => {
      numero++;
      teams.push(`${numero};${tipo.email};TYPE;m;TYPE MAÑANA`);
      i++;
    });
    ...
    typeFulllTime.forEach((tipo) => {
      numero++;
      teams.push(`${numero};${tipo.email};TYPE;ft;TYPE FULL`);
      i++;
    });
    ...
    //     numero++;
    //   }
    //   teams.push(`${numero};${JAVA.email};JAVA;MAÑANA;JAVA REACT MAÑANA`);
    //   i++;
    // });
    ...
    //     numero++;
    //   }
    //   teams.push(`${numero};${JAVA.email};JAVA;FULL;JAVA REACT FULL`);
    //   i++;
    // });
    ...
    pyNoche.forEach((py) => {
      ...
      teams.push(`${numero};${py.email};python;n;python`);
      i++;
    });
    ...
    pyTarde.forEach((py) => {
      ...
      teams.push(`${numero};${py.email};python;t;python`);
      i++;
    });
    ...
    pyManana.forEach((py) => {
      ...
      teams.push(`${numero};${py.email};python;m;python`);
      i++;
    });
    ...
    pyFullTime.forEach((py) => {
      ...
      teams.push(`${numero};${py.email};python;ft;python`);
      i++;
    });
    ...
    if (teams.length > 0) {
      ...
      // fs.writeFileSync("Template C18.txt", fullnamesWithSpace);
    }
  } catch (error) {
    console.log(error);
  }
